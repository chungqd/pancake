                                ...
                                <div class="col-sm-3">
                                    ...
                                    @endif
                                        ...
                                        <div class="single-item-caption">
                                            <a class="add-to-cart pull-left" href="{{ route('cart', $newProduct->id) }}"><i class="fa fa-shopping-cart"></i></a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="single-item">
                                        ...
                                        <div class="single-item-caption">
                                            <a class="add-to-cart pull-left" href="{{ route('cart', $prs->id) }}"><i class="fa fa-shopping-cart"></i></a>
